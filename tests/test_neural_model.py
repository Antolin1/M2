...
class TestNeuralModel(unittest.TestCase):
    def test_training(self):
        ...
        initial_graph.add_node(1, type='Region')
        initial_graph.add_edge(0, 1, type='regions')
        pallete = Pallete([get_complex_add_transition_edit_operation()] + edit_operations, [initial_graph])
        ...
        model.eval()
        samples = [sample_graph(initial_graph, pallete, model, 50) for i in range(5)]
